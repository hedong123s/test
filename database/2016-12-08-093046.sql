...
CREATE TABLE `qo_players` (
  ...
  `name` varchar(40) NOT NULL COMMENT '选手姓名',
  `idcard` varchar(20) NOT NULL COMMENT '选手身份证号',
  `sex` tinyint(2) DEFAULT '0' COMMENT '选手性别，0为未知，1为男，2为女',
  `birthday` date DEFAULT NULL COMMENT '选手生日 YYYY-MM-DD',
  `created_at` int(10) NOT NULL DEFAULT '0' COMMENT '创建时间',
  `updated_at` int(10) NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `qo_users` (
  ...
  `team_teacher_mobile` varchar(20) DEFAULT '' COMMENT '带队老师联系方式',
