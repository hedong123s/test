...
CREATE TABLE `qo_match_events` (
  ...
  `event_number` int(10) NOT NULL DEFAULT '0' COMMENT '组别编码',
  ...
  `ipate` varchar(20) DEFAULT '' COMMENT '归属板块  PROC 职业组; SPEC 专业组; AMAT 业余组; TAS 师生组; AMAT:ELITE 精英组; AMAT:ORDIN 普通组;',
  `age_type` tinyint(2) DEFAULT '0' COMMENT '年龄限制类型，0为不限，1为上限（如1999年前），2为下限（1999年后）',
  `age_date` date DEFAULT '0000-00-00' COMMENT '年龄限制的年月日，age_type为0时为空',
  ...
  KEY `ipate` (`ipate`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='赛程 - 组别表';

/*Data for the table `qo_match_events` */

insert  into `qo_match_events`(`id`,`match_id`,`group_id`,`event_number`,`event_title`,`dances`,`fee`,`ipate`,`age_type`,`age_date`,`person_type`,`person_sex_str`,`created_at`,`updated_at`) values (1,4,3,1,'aaa','W,T,VW','11.00','',1,'2014-01-01',1,'2',1482567330,1482644790),(2,4,3,2,'aaa','W,VW,F','12.00','',0,'0000-00-00',2,'2,1',1482567384,1482567384),(3,4,3,3,'123123123','','11.00','SPEC',2,'2016-01-01',3,'1,1,1,1,2,1',1482568046,1483024428),(4,4,3,11,'112','W,T,C,R','2112.00','',0,'0000-00-00',3,'0,0,0,0,0,0',1482568253,1482568253),(5,4,3,12312,'123','W,T,VW','12.00','PROC',1,'2015-01-01',1,'0',1483023657,1483023657),(6,4,3,1256,'1432','T,VW,F','31.00','AMAT:ELITE',2,'2016-01-01',1,'0',1483023684,1483024399),(7,5,4,33,'2','W,T','12.00','AMAT:ORDIN',1,'2014-01-01',4,'',1483024583,1483024583);
...
/*Data for the table `qo_match_ipate_relation@DELETE` */

insert  into `qo_match_ipate_relation@DELETE`(`id`,`pid`) values (1,0),(2,0),(3,0),(6,1),(6,2),(6,3);

/*Table structure for table `qo_match_ipates@DELETE` */

DROP TABLE IF EXISTS `qo_match_ipates@DELETE`;

CREATE TABLE `qo_match_ipates@DELETE` (
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='赛程板块表';

/*Data for the table `qo_match_ipates@DELETE` */

insert  into `qo_match_ipates@DELETE`(`id`,`match_id`,`name`,`ident`,`is_cross`,`created_at`,`updated_at`) values (1,4,'职业组','PROC',1,1481767631,1482417299),(2,4,'专业组','SPEC',0,1481767631,1482417295),(3,4,'业余组','AMAT',0,1481767631,1481767631),(6,4,'师生组','',0,1482418972,1482418996);
...
CREATE TABLE `qo_players` (
  ...
  KEY `sex` (`sex`),
  KEY `type` (`type`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='选手表（必须实名认证通过的人才可写入此表）';

/*Data for the table `qo_players` */

insert  into `qo_players`(`id`,`type`,`name`,`idcard`,`sex`,`birthday`,`created_at`,`updated_at`) values (1,1,'何东','2012312312312312321',NULL,NULL,1482162479,0),(2,1,'何东','421083198901102132',0,'1989-01-10',1482162610,0),(3,1,'李浩','421083199011113212',0,'1990-11-11',1482330397,0);

/*Table structure for table `qo_r_match_event_ipate@DELETE` */

DROP TABLE IF EXISTS `qo_r_match_event_ipate@DELETE`;

CREATE TABLE `qo_r_match_event_ipate@DELETE` (
  `event_id` int(10) NOT NULL DEFAULT '0' COMMENT '组别ID',
  `ipate_id` int(10) NOT NULL DEFAULT '0' COMMENT '板块ID',
  PRIMARY KEY (`event_id`,`ipate_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='组别、板块关联表';

/*Data for the table `qo_r_match_event_ipate@DELETE` */

insert  into `qo_r_match_event_ipate@DELETE`(`event_id`,`ipate_id`) values (1,1),(1,2),(1,6),(2,1),(2,6),(3,1),(3,2),(3,6),(4,1),(4,6);
